...
const Data = () => {
  return (
    <div className="home__data  ">
      ...
      <h3 className="home__subtitle"> DevOps Engineer | Cloud | Software Dev.</h3>
...
DevOps Engineer with over 6 years of experience building scalable, reliable, and secure systems across public clouds and
